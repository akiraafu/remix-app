        ...
        <div className="rounded-lg border p-3">
            ...
            <div>
                <Form method="POST">
                    ...
                    {navigation.state === 'submitting' ? (<button type="button" disabled className="bg-teal-500 px-4 py-2 rounded-lg text-white">Loading...</button>) :(<button type="submit" className="bg-teal-500 px-4 py-2 rounded-lg text-white">Add Comment</button>)}
                </Form>
